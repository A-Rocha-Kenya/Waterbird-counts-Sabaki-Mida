...
counts <- countst %>% 
  filter(date<"2004-02-02" & date>"2004-02-01") %>% 
...
## Write to Excel
```{r}
write.csv(events, file = paste0(path,"Waterbird-counts-Sabaki-Mida/data/events.csv"), 
          na = "", row.names = FALSE, fileEncoding = "UTF-8")

write.csv(occurences, file = paste0(path,"Waterbird-counts-Sabaki-Mida/data/occurences.csv"), 
          na = "", row.names = FALSE, fileEncoding = "UTF-8")
```
